...
**Havenpass --- Creator and Developer** *(2026 -- present)*  
Narrative engine in which a Director agent frames scenes and Actor agents perform them against a shared, append-only event-sourced blackboard, compiling played sessions into a finished manuscript. Python, local and hybrid cloud model serving. Architecture derived from a synthesis of twenty-three papers in the agent-architecture and interactive-narrative literature, with each design decision attributed to its source.

**Beta Tester, BearcatGPT --- enterprise LLM pilot** *(2024 -- 2026)*  
Digital Technology Solutions, University of Cincinnati
...
Majors and non-majors produce real creative work with generative tools under per-assignment rules on permitted use, scheduled checkpoints, and two-way disclosure: students document their AI use as graded work, and the instructor documents his in the course materials.
...
- prompt engineering
- local model serving (Ollama, Unsloth)
- vector databases (ChromaDB)
- hybrid local/cloud deployment
- evaluation and disclosure design
...
- Google Generative AI for Educators (Skillshop)
- AI & Instructional Design (LearnWorlds)
- Google Project Management Career Specialization (Coursera)

**University coursework, University of Cincinnati** *(2025 -- 2026)*  

- Applied Artificial Intelligence and Machine Learning Tools
...
**Associate Professor, Media Communications & Technology** *(2016 -- present)*  
University of Cincinnati Blue Ash College. Teaching since 2005; tenure-track since 2010. Courses include:

- American Cinema
- World Cinema
- Media Aesthetics
- Media Design Foundations I
- Preproduction Planning
- Professional Practice
- Degree Project Studio
- Applied Media Methods

**eMedia Coordinator, Metro (Cincinnati Public Transit)** *(2008 -- 2010)*  
Produced training video and television commercials; maintained the public website and social media presence.

**Web Designer / Developer, freelance and agency** *(1999 -- 2008)*  
Clients included Paramount Parks, Cincinnati Metro, Lang Financial, IO Productions, F+W Publishing, and the University of Cincinnati Department of Surgery. Concept, copywriting, design, programming, and scripting.
...
**Member, AIEOU (AI in Education, Oxford University) Research Hub** *(2026 -- present)*

**Member, Enterprise Technology Association --- Cincy AI Week community** *(2026 -- present)*
...
**B.A., Electronic Media --- Xavier University** *(2007)*

**Dual B.A., Communication and English --- University of Louisville** *(2000)*
